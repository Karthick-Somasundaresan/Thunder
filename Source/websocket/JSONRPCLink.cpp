...
template class WPEFramework::JSONRPC::LinkType<WPEFramework::Core::JSON::IElement>;
template class WPEFramework::JSONRPC::LinkType<WPEFramework::Core::JSON::IMessagePack>;
